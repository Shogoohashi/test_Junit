...
public class PasswordTest {
	...
	public void No1＿パスワード_半角数字() {
		...
		assertThat(SignupForm.getPassword().matches("^[0-9a-z.?/-]{8,20}"));
    }
	...
	@Test
	public void No10＿パスワード_半角数字_全角ひら() {
		this.SignupForm.setPassword("🌸🌸🌸🌸");
		assertThat(SignupForm.getPassword().matches("^[0-9a-z.?/-]{8,20}"));
    }
	@Test
	public void No11＿パスワード_半角数字_全角カナ() {
		this.SignupForm.setPassword("あああ1111");
		assertThat(SignupForm.getPassword().matches("^[0-9a-z.?/-]{8,20}"));
    }
	@Test
	public void No12＿パスワード_半角数字_全角アルファベット() {
		this.SignupForm.setPassword("アアア111");
		assertThat(SignupForm.getPassword().matches("^[0-9a-z.?/-]{8,20}"));
    }
	@Test
	public void No13＿パスワード_半角数字_全角記号() {
		this.SignupForm.setPassword("ａａａａ1111");
		assertThat(SignupForm.getPassword().matches("^[0-9a-z.?/-]{8,20}"));
    }
	@Test
	public void No14＿パスワード_半角数字_全角数字() {
		this.SignupForm.setPassword("／／／／／／1111");
		assertThat(SignupForm.getPassword().matches("^[0-9a-z.?/-]{8,20}"));
    }
	@Test
	public void No15＿パスワード_絵文字() {
		this.SignupForm.setPassword("１１１１1111");
		assertThat(SignupForm.getPassword().matches("^[0-9a-z.?/-]{8,20}"));
    }
	@Test
	...
	public void No27＿パスワード_半角数字_半角アルファベット() {
		this.SignupForm.setPassword("1111 aaaaaa");
		assertThat(SignupForm.getPassword().matches("^[0-9a-z.?/-]{8,20}"));
    }
	@Test
